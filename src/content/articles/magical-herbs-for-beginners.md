...
category: "Herbalism"
keywords:
  - magical herbs for beginners
  - herb magic safety
  - smudge stick alternatives
freeResources:
  - name: "NCCIH (NIH) — Herbs at a Glance"
    url: "https://www.nccih.nih.gov/health/herbsataglance"
    note: "The National Institutes of Health's free, plain-language safety reference on individual herbs — drug interactions, side effects, what's actually been studied. Read this before ingesting or burning anything, not after."
products:
  - name: "Cunningham's Encyclopedia of Magical Herbs — Scott Cunningham"
    asin: "0875421229"
    image: "/images/products/cunningham-magical-herbs-1.jpg"
    note: "The standard reference for the folkloric/magical associations of herbs specifically — not a medical or dosage guide. Use it for tradition and correspondence, and the NIH resource above for anything about safety or ingestion."
  - name: "Rosemary Smudge Sticks (White-Sage-Free Alternative)"
    asin: "B08B47B8VJ"
    image: "/images/products/rosemary-smudge-sticks-1.jpg"
    note: "See the sourcing note below before buying any smoke-cleansing bundle — wild-harvested white sage has real sustainability and cultural concerns worth knowing about. Rosemary is a widely used, easily cultivated alternative. Check the specific listing's exact ingredients before buying, since sourcing varies."
  - name: "Dried Herbs & Flowers Collection (Craft Use)"
    asin: "B0GQC73YX3"
...
## Read the NIH resource before doing anything with a specific herb

Before burning, brewing, or otherwise using any specific herb, check it against the free NIH reference above. This matters most if you're on any medication, pregnant, breastfeeding, or managing a health condition — herb-drug interactions are real and not always intuitive (St. John's Wort, for example, interferes with a long list of common prescriptions).

## Craft/ritual use vs. ingestion are different questions

A bag of dried botanicals sold for "spell jars and candle making" is not the same product as culinary-grade dried herbs sold for tea, even when it's technically the same plant. Craft-grade herbs aren't held to food-safety standards. If you want to drink an herbal tea as part of a practice, buy actual food-grade herbs from a grocery or spice retailer — don't assume a witchcraft-supply bag is safe to ingest just because the plant name matches.
...
Cunningham's book is the right place to look up what a given herb is traditionally associated with — protection, love, cleansing, and so on. It is not a safety or dosage reference, and was never written as one; pair it with the NIH page above rather than treating it as the only source you check before using something.
